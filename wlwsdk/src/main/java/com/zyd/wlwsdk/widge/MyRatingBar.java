...
/**
 * Created by hygo02 on 2017/10/12.
 */
...
public class MyRatingBar extends LinearLayout {
    ...
    private void initView() {
        ...
        for (int i = 0; i < countNum; i++) {
            ...
            cb.setOnClickListener(new MyRatingBar.MyClickListener(i));
        }
    ...
    private MyRatingBar.OnRatingChangeListener mOnRatingChangeListener;

    public MyRatingBar.OnRatingChangeListener getOnRatingChangeListener() {
        return mOnRatingChangeListener;
    }

    public void setOnRatingChangeListener(MyRatingBar.OnRatingChangeListener onRatingChangeListener) {
