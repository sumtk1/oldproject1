...
public class MessageManager {
    ...
    // 用于广播发送标志
    public static final String NEW_MESSAGE = "GLOIOT_NEW_MESSAGE";              // 收到新消息
    public static final String REFRESH_USERINFO = "GLOIOT_REFRESH_USERINFO";    // 用户信息刷新
    public static final String LINK_CHANGED = "LINK_CHANGED";                   // 链接状态改变
    // 链接状态
    public static final String LINK_CHANGED_SUCCEED = "LINK_CHANGED_SUCCEED";   // 链接成功
    public static final String LINK_CHANGED_FAULT = "LINK_CHANGED_FAULT";       // 链接失败
    public static final String LINK_CHANGED_DONW = "LINK_CHANGED_DONW";         // 用户强制下线
